...
const WA_MSG = encodeURIComponent('Hola, quiero comenzar mi transformación natural con Ganoderma')
  ...
  return (
    <section id="contacto" className="py-20 px-8 md:px-16 bg-amber flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <a
        ...
        className="inline-flex items-center gap-3 bg-white text-amber font-sans text-[0.8rem] tracking-widest uppercase px-8 py-4 hover:bg-forest hover:text-cream transition-all duration-200 whitespace-nowrap"
      >
