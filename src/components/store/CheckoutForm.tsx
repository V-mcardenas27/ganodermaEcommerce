...
export function CheckoutForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      {/* Datos del cliente */}
      <div>
        <h2 className="font-serif text-xl text-forest mb-5">Datos de envío</h2>
      ...
      <a
        href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Hola, quiero hacer un pedido de Cápsulas Ganoderma Lucidum')}`}
        target="_blank"
        rel="noopener noreferrer"
        className="w-full flex items-center justify-center gap-3 bg-[#25D366] text-white font-sans text-[0.82rem] tracking-widest uppercase py-3 hover:bg-[#1da851] transition-colors"
      >
